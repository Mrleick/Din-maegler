          ...
          <div className="flex mt-[40px]">
            <div className="flex">
              ...
              <div className="flex flex-col ml-[20px]">
                <h3 className="font-medium text-[24px]">4829</h3>
                <p className="text-[18px]">Boliger solgt</p>
              </div>
            </div>
            ...
            <div className="flex ml-[97px]">
              ...
              <div className="flex flex-col ml-[20px]">
                <h3 className="font-medium text-[24px]">158</h3>
                <p className="text-[18px]">Boliger til salg</p>
              </div>
            </div>
          </div>
        </div>
